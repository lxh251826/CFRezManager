...
PNG, JPG, BMP, GIF, and TIFF image files inside REZ archives lazy-load thumbnails when they become visible. Files that cannot be decoded still use the normal file icon.
